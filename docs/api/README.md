...
| Fayl | Nima haqida |
|---|---|
| [campaigns.md](campaigns.md) | Kampaniyalar: yaratish, nishonlar (targets), CSV import, start/pause |
...
| [reports.md](reports.md) | Dashboard KPI/grafiklar, qo'ng'iroqlar tarixi, audit jurnali, recording |
