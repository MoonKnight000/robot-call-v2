...
| `dtmfInputEnabled` | `boolean` | ❌ | Klaviatura raqamlarini (0-9) mijoz javobi sifatida qabul qilish. Har bosilgan raqam alohida turn bo'ladi va bot gapirayotgan bo'lsa uni to'xtatadi; `*`, `#` va A-D e'tiborsiz qoldiriladi. Faqat cascade pipeline'da ishlaydi (`engineConfig.mode = CASCADE`) |
