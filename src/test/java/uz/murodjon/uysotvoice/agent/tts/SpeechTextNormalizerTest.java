...
class SpeechTextNormalizerTest {
    ...
    /** Russian numerals are normalized by the providers themselves — see the class javadoc. */
    @Test
    void leavesOtherLanguagesAlone() {
        String line = "1500000 сум до 2026-07-01";
        assertThat(SpeechTextNormalizer.normalize(line, "ru-RU")).isEqualTo(line);
    }
}
