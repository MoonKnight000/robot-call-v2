...
public class ContactRepository {
    ...
    public ContactRow find(long id) {
    ...
    public List<ContactRow> findAll(ContactFilter filter) {
    ...
    private static ContactRow toRow(Contact e) {
        return new ContactRow(e.getId(), e.getName(), e.getPhone(), e.getAddress(), e.getTags(),
