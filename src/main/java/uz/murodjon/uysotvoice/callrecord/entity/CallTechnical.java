...
/**
 * JPA entity for {@code call_technical} (§10.5 "Texnik" tab): channel/trunk, AMD
 * result, STT/TTS/LLM identity, token usage and turn-latency stats — one row per
 * call, written once at teardown by {@code CallFinalizer}.
 */
@Entity
@Table(name = "call_technical")
public class CallTechnical {
