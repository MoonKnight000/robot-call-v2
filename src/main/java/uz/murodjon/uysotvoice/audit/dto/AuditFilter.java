...
/**
 * Pagination + sort for {@code POST /api/reports/audit/list}. {@code page}/{@code size}
 * may be omitted (defaulted by {@link FilterInterface}), but a value that is present and
 * out of range is rejected rather than silently clamped.
 */
