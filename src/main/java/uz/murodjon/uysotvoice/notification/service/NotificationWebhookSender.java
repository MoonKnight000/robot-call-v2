...
/**
 * Delivers one notification event as a plain HTTP POST (§11 settings) — same {@code
 * HttpClient} pattern as {@code crm.service.CrmClient}. Swallow-and-log on failure: a
 * notification channel must never break the event that raised it.
 */
@Component
