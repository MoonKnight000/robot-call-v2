...
public interface ScenarioController {
    ...
    ResponseEntity<ResponseData<Scenario>> create(@Valid @RequestBody CreateScenarioRequest r);

    @PostMapping("/scenarios/list")
    ResponseEntity<ResponseData<PageableData<Scenario>>> list(@Valid @RequestBody ScenarioFilter filter);

    @GetMapping("/scenarios/{id}")
    ResponseEntity<ResponseData<Scenario>> get(@PathVariable long id);

    @PutMapping("/scenarios/{id}")
    ResponseEntity<ResponseData<Scenario>> update(@PathVariable long id, @Valid @RequestBody UpdateScenarioRequest r);

    @PostMapping("/scenarios/{id}/clone")
    ResponseEntity<ResponseData<Scenario>> clone(@PathVariable long id, @Valid @RequestBody CloneScenarioRequest r);
