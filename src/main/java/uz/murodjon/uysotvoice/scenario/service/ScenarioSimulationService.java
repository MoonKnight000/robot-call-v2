...
import uz.murodjon.uysotvoice.scenario.dto.*;
import uz.murodjon.uysotvoice.shared.exception.ValidationException;

import java.util.*;

/**
 * Provides text-based and AI-vs-AI automated test simulation for Scenarios without telecom/SIP calls.
 */
@Service
public class ScenarioSimulationService {
    ...
    public ScenarioSimulationService(ScenarioService scenarioService,
    ...
    /**
     * Executes automated multi-turn AI vs AI test with predefined customer personas.
     */
    public List<PersonaTestResult> runPersonaTests(Long scenarioId) {
        ...
        // Persona 1: Cooperative customer (Ready to pay on Friday)
        ...
        // Persona 2: Difficult customer with financial issues
        ...
        // Persona 3: Wrong person / wrong number
