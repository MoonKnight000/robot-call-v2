 ...
 * @param moods            moods the model can actually speak. The dialog names the mood a
 *                         turn calls for ({@code strict}, {@code whisper}, ...) without
 *                         knowing the voice; one that is not in this list is spoken with
 *                         {@code speaker} instead
